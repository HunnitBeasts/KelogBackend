...
public class QSeriesPost extends EntityPathBase<SeriesPost> {
    ...
    private static final long serialVersionUID = 614738362L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QSeriesPost seriesPost = new QSeriesPost("seriesPost");

    public final com.hunnit_beasts.kelog.entity.compositekey.QSeriesPostId id;
    ...
    public QSeriesPost(Class<? extends SeriesPost> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.hunnit_beasts.kelog.entity.compositekey.QSeriesPostId(forProperty("id")) : null;
