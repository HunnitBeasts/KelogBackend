...
public class QPostViewCnt extends EntityPathBase<PostViewCnt> {
    ...
    private static final long serialVersionUID = 497003041L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPostViewCnt postViewCnt = new QPostViewCnt("postViewCnt");

    public final com.hunnit_beasts.kelog.entity.compositekey.QPostViewCntId id;
    ...
    public QPostViewCnt(Class<? extends PostViewCnt> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.hunnit_beasts.kelog.entity.compositekey.QPostViewCntId(forProperty("id")) : null;
