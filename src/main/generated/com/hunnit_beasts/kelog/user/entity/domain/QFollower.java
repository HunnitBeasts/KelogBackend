...
public class QFollower extends EntityPathBase<Follower> {
    ...
    private static final long serialVersionUID = 1824825692L;
    ...
    public final com.hunnit_beasts.kelog.user.entity.compositekey.QFollowerId id;
    ...
    public QFollower(Class<? extends Follower> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.hunnit_beasts.kelog.user.entity.compositekey.QFollowerId(forProperty("id")) : null;
    }
