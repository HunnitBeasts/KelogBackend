...
public class QComment extends EntityPathBase<Comment> {
    ...
    public final ListPath<Comment, QComment> childReComments = this.<Comment, QComment>createList("childReComments", Comment.class, QComment.class, PathInits.DIRECT2);
    ...
    public final QComment parentReComment;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.parentReComment = inits.isInitialized("parentReComment") ? new QComment(forProperty("parentReComment"), inits.get("parentReComment")) : null;
