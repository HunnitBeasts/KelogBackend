...
public class QIncompletePost extends EntityPathBase<IncompletePost> {
    ...
    private static final long serialVersionUID = 1253175201L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QIncompletePost incompletePost = new QIncompletePost("incompletePost");

    public final com.hunnit_beasts.kelog.entity.compositekey.QIncompletePostId id;
    ...
    public QIncompletePost(Class<? extends IncompletePost> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.hunnit_beasts.kelog.entity.compositekey.QIncompletePostId(forProperty("id")) : null;
