...
public class QTagPost extends EntityPathBase<TagPost> {
    ...
    private static final long serialVersionUID = 1139277169L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QTagPost tagPost = new QTagPost("tagPost");

    public final com.hunnit_beasts.kelog.post.entity.compositekey.QTagPostId id;
    ...
    public QTagPost(Class<? extends TagPost> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.hunnit_beasts.kelog.post.entity.compositekey.QTagPostId(forProperty("id")) : null;
