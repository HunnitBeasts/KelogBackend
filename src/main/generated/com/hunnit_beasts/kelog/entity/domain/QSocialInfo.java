...
public class QSocialInfo extends EntityPathBase<SocialInfo> {
    ...
    private static final long serialVersionUID = -773479490L;
    ...
    public final EnumPath<com.hunnit_beasts.kelog.enumeration.types.SocialType> type = createEnum("type", com.hunnit_beasts.kelog.enumeration.types.SocialType.class);
