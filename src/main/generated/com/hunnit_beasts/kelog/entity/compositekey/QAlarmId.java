...
public class QAlarmId extends BeanPath<AlarmId> {
    ...
    private static final long serialVersionUID = 948142237L;

    public static final QAlarmId alarmId = new QAlarmId("alarmId");

    public final EnumPath<com.hunnit_beasts.kelog.enumeration.types.AlarmType> alarmType = createEnum("alarmType", com.hunnit_beasts.kelog.enumeration.types.AlarmType.class);
